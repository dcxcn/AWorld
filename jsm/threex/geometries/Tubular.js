...
var Tubular = function ( pp, tubularSegments, radius, radialSegments, closed, geoType, CurveType ) {
...
Tubular.prototype = Object.create( BufferGeometry.prototype );
Tubular.prototype.constructor = Tubular;

Tubular.prototype.addDebug = function ( scene ) {
...
Tubular.prototype.setTension = function ( v ) {

    this.path.tension = v;

}

Tubular.prototype.generateSegment = function ( i ) {
...
Tubular.prototype.generateIndicesAndUv = function (  ) {
...
Tubular.prototype.generatePath = function ( path ) {
...
Tubular.prototype.updatePath = function ( F ) {
...
Tubular.prototype.updateUV = function () {
...
Tubular.prototype.updateIndices = function (  ) {
