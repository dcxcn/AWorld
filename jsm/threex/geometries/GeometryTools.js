...
var GeometryTools = {
    ...
    addVertexColor: function( geometry ){
        ...
        var color = new Float32BufferAttribute( geometry.attributes.position.count*3, 3 );
        var i = color.count, n;
    ...
    mergeGeometryArray : function( geos ){
        ...
        var i = geos.length;
        while(i--){
            tmp[i] = new Geometry().fromBufferGeometry( geos[i] );
            //tmp[i].mergeVertices();
        }
        ...
        var geometry = new BufferGeometry().fromGeometry( g );
        g.dispose();
    ...
    prepaGeometry : function ( g, type ) {
        ...
        var tmpGeo = new Geometry().fromBufferGeometry( g );
    ...
    getGeomtryInfo: function ( o ) {
        ...
        //if(o.geometry instanceof Geometry) console.log( 'is geometry')
        if(o.geometry instanceof BufferGeometry) isBufferGeo = true;

        var tmpGeo = isBufferGeo ? new Geometry().fromBufferGeometry( o.geometry ) : o.geometry;
