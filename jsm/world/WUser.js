...
var WUser = function() {	
	...
	var _user = Object.assign(Object.create( EventDispatcher.prototype), {
		// 属性
		...
		init: function() {
			//添加监听
			document.addEventListener("keydown", _user.keyboard.onKeyDown, false);
			document.addEventListener("keyup", _user.keyboard.onKeyUp, false);
			document.addEventListener("mousewheel", _user.mouse.onMousewheel,false);
			document.addEventListener("mousedown", _user.mouse.onMouseDown, false );
			document.addEventListener("mouseup", _user.mouse.onMouseUp, false );
			document.addEventListener("mousemove", _user.mouse.onMouseMove, false );
		},
		onKeyDown: function() {
			// 默认没有
		}
