...
Object.assign( SoftBody.prototype, {
	...
	step: function ( AR, N ) {
		...
		this.softs.forEach( function ( b ) {
			...
			s = b.get_m_nodes(); // get vertrices list   42
			j = s.size();
			while ( j -- ) {
	...
	add: function ( o ) {
		...
		switch ( o.type ) {
			...
			case 'softCloth':
				...
				if(o.corners && o.corners.enabled){
					p1.fromArray(o.corners.pos00);
					p2.fromArray(o.corners.pos01);
					p3.fromArray(o.corners.pos10);
					p4.fromArray(o.corners.pos11);
				}else{
					if(o.direction.align=='H'){
						p1.fromArray( [ - mw + o.pos[0],  o.pos[1], - mh+o.pos[2] ] );
						p2.fromArray( [   mw + o.pos[0],  o.pos[1], - mh+o.pos[2] ] );
						p3.fromArray( [ - mw + o.pos[0],  o.pos[1],   mh+o.pos[2] ] );
						p4.fromArray( [   mw + o.pos[0],  o.pos[1],   mh+o.pos[2] ] );
					}else{
						if(o.direction.align == 'V_T'){//上边 position
							if(o.direction.face2=='X'){
								p1.fromArray( [ o.pos[0],  o.pos[1] - mh, o.pos[2] - mw ] );
								p2.fromArray( [ o.pos[0],  o.pos[1] - mh, o.pos[2] + mw ] );
								p3.fromArray( [ o.pos[0],  o.pos[1] + mh, o.pos[2] - mw ] );
								p4.fromArray( [ o.pos[0],  o.pos[1] + mh, o.pos[2] + mw] );
								
							}else if(o.direction.face2=='Z'){
								p1.fromArray( [ o.pos[0] - mw,  o.pos[1] - mh, o.pos[2] ] );
								p2.fromArray( [ o.pos[0] + mw,  o.pos[1] - mh, o.pos[2]  ] );
								p3.fromArray( [ o.pos[0] - mw,  o.pos[1] + mh, o.pos[2] ] );
								p4.fromArray( [ o.pos[0] + mw,  o.pos[1] + mh, o.pos[2]] );
							}
						
						}else if(o.direction.align == 'V_B'){//下边 position
							if(o.direction.face2=='X'){
								p1.fromArray( [ o.pos[0],  o.pos[1] + mh, o.pos[2] + mw] );
								p2.fromArray( [ o.pos[0],  o.pos[1] + mh, o.pos[2] - mw ] );
								p3.fromArray( [ o.pos[0],  o.pos[1] - mh, o.pos[2] + mw ] );
						...
						}else if(o.direction.align == 'V_C'){//中间 position
							if(o.direction.face2=='X'){
								p1.fromArray( [ o.pos[0],  o.pos[1] , o.pos[2] ] );
								p2.fromArray( [ o.pos[0],  o.pos[1] , o.pos[2] - 2* mw ] );
								p3.fromArray( [ o.pos[0],  o.pos[1] - 2 * mh, o.pos[2] ] );
								p4.fromArray( [ o.pos[0],  o.pos[1] - 2 * mh, o.pos[2] - 2 * mw ] );
							}else if(o.direction.face2=='Z'){
								p1.fromArray( [ o.pos[0],  o.pos[1] , o.pos[2] ] );
								p2.fromArray( [ o.pos[0] - 2* mw,  o.pos[1] , o.pos[2] ] );
								p3.fromArray( [ o.pos[0],  o.pos[1] - 2 * mh, o.pos[2] ] );
								p4.fromArray( [ o.pos[0] - 2 * mw,  o.pos[1] - 2 * mh, o.pos[2] ] );
							}
						}
					}
				}
