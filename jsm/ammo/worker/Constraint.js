...
Object.assign( Constraint.prototype, {
	...
	add: function ( o ) {
		...
		if ( o.type !== "joint_p2p" && o.type !== "joint_hinge" && o.type !== "joint" ) {
			...
			if ( ! local ) { // worldToLocal
				...
				//t.identity();
				//t.setOrigin( posA );
				//t.quaternionFromArray( o.quatA );
				t.identity().fromArray( o.pos1.concat( o.quat1 ) );
				//t.quartenionFromAxis( o.axe1 || [ 1, 0, 0 ] );
				//t.setFromDirection( o.axe1 || [ 1, 0, 0 ], 90*math.torad );
				b1.getMotionState().getWorldTransform( formA );
				//formA.toArray(debugArray1,0,1);
				//debugger;
				formA = formA.getInverse().multiply( t );
				//formA.multiply( t );
				//oo = formA.getOrigin();
				//debugger;
				
				//formA.toArray(debugArray2,0,1);
				//debugger;
				//console.log('formA.toArray--'+oo);	
				// frame B
				//t.identity();
				//t.setOrigin( posB );
				//t.quaternionFromArray( o.quatB );
				t.identity().fromArray( o.pos2.concat( o.quat2 ) );
				//t.quartenionFromAxis( o.axe2 || [ 1, 0, 0 ], 90*math.torad  );
				//t.setFromDirection( o.axe2 || [ 1, 0, 0 ] );
				b2.getMotionState().getWorldTransform( formB );
				formB = formB.getInverse().multiply( t );
				//formB.multiply( t );
				//oo = formB.getOrigin();
				//console.log('formB.toArray--'+oo);	
				t.free();
				...
				if ( o.quat1 !== undefined ) formA.quaternionFromArray( o.quat1 );
				...
				if ( o.quat2 !== undefined ) formB.quaternionFromArray( o.quat2 );
		...
		if ( o.spring && joint.enableSpring && joint.setStiffness ) {
			...
			for ( var i = 0; i < 3; i ++ ) {
				...
				if ( o.spring[ i ] !== 0 ) {
					...
					joint.setStiffness( i + 3, o.spring[ i ] );
				}else{
					joint.enableSpring( i + 3, false );
				}
			}
		}
	...
	applyOption: function ( joint, o ) {
		if(o.type === 'joint_hinge'){
			if(o.limit){
				joint.setLimit( 
				o.limit[ 0 ] * math.torad, 
				o.limit[ 1 ] * math.torad, 
				o.limit[ 2 ] !==undefined ? o.limit[ 2 ] : 0.9, 
				o.limit[ 3 ] !==undefined ? o.limit[ 3 ] : 0.3, 
				o.limit[ 4 ] !==undefined ? o.limit[ 4 ] : 1.0 );
				console.log('applyOption===joint_hinge==='+o.limit);
				
			}
			if( o.motor && joint.enableAngularMotor ) {
				joint.enableAngularMotor( o.motor[ 0 ], o.motor[ 1 ], o.motor[ 2 ] );
			}
		}
