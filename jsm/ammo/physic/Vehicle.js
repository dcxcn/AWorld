...
import { CarHelper } from '../../threex/helper/CarHelper.js';
/**   _   _____ _   _
*    | | |_   _| |_| |
*    | |_ _| | |  _  |
*    |___|_|_| |_| |_|
...
Object.assign( Vehicle.prototype, {
	...
	step: function ( AR, N ) {
		...
		this.cars.forEach( function ( b, id ) {
			...
			//console.log('car pos '+b.position.x+' '+b.position.y+' '+b.position.z);
	...
	add: function ( o ) {
		...
		for ( var i = 0; i < n; i ++ ) {
	        ...
	        if ( o.meshSusp ) {
	            ...
	            if ( i == 0 || i == 1 ) m.position.z = wPos[ 2 ]; else m.position.z = - wPos[ 2 ];
	    ...
	    if ( o.helper ) {
	        ...
	        mesh.userData.helper = new CarHelper( wPos, o.massCenter, deep );
