...
Object.assign( RigidBody.prototype, {
	...
	step: function ( AR, N ) {
		...
		this.bodys.forEach( function ( b, id ) {
			...
			if(b.visible){
				if(b.isGroup){
					b.children.forEach(function(b2,id){
						if(b2.type!='Mesh') return;
						if ( s > 0 ) {
					
							if ( b2.material.name == 'sleep' ) b2.material = root.mat.move;
							if ( s > 50 && b2.material.name == 'move' ) b2.material = root.mat.speed;
							else if ( s < 50 && b2.material.name == 'speed' ) b2.material = root.mat.move;

						} else {

							if ( b2.material.name == 'move' || b2.material.name == 'speed' ) b2.material = root.mat.sleep;
	...
	add: function ( o, extra ) {
		...
		if ( o.type === 'compound' ) { 
	        ...
	        if ( o.geometry ) {
	            ...
	            if (!o.mesh) mesh = new THREE.Mesh( o.shape, material );
	    ...
	    if ( mesh || o.mesh) {
		    ...
		    }else if ( !customGeo && !mesh.isGroup ){ 
	        ...
	        mesh.enabled = true;
	        //mesh.type = 'rigidbody';
			if(o.flag && o.flag==2) mesh.visible = false;
	        ...
	        if( o.noShadow === undefined ){
	        	...
	        	mesh.castShadow = (o.castShadow)?o.castShadow: (o.mass === 0 && !o.kinematic ? false : true);
